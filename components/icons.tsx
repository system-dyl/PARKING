...
export const CarIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-6H3l4 6h10zM5 16v4h2v-4H5zm12 0v4h2v-4h-2z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10l1.5-5h15L21 10M3 10v6h18v-6" />
  </svg>
);
...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="8" y="15" width="2" height="3" rx="1" fill="rgba(255,255,255,0.5)"/>
    <rect x="14" y="15" width="2" height="3" rx="1" fill="rgba(255,255,255,0.5)"/>
  </svg>
);
